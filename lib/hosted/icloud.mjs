...
function mailOrigin(value, region) {
  ...
  // Apple also returns maildomainws-china hosts. The suffix below still binds the account region.
  const host = /^(?:p\d+-)?maildomainws(?:-china)?\.(icloud\.com(?:\.cn)?)$/.exec(url.hostname);
